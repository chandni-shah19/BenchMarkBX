...
public class RunTrafo_BWD {
	 ...
	 */
	public RunTrafo_BWD(OutputStream outputStream) {
	...
	/**
	 * Example usage of the class {@link RunTrafo_BWD}.
	 * 
	 * @param args
	 *            are ignored here!
	 */
	public static void main(String[] args) {
		...
		RunTrafo_BWD simpleQVT = new RunTrafo_BWD(System.out);
	...
	public void launch() {
		...
		String basePath = "./instances/" + "org.eclipse";
		...
		File targetFile = new File(basePath + "/qvtsource.xmi");
		targetFile.delete();
		
		Resource resource1 = this.getResource(basePath + "/qvtsource.xmi");
		Resource resource2 = this.getResource(basePath + "/fwd.trg.xmi");
		...
		File tracesFile = new File("./traces/trace.trafo");
		tracesFile.delete();
		...
		try {
			qvtRuleSet = new FileReader("./qvt/trafo.qvt"); // TODO: adjust the filename!
	...
	protected void collectMetaModels(Collection<EPackage> metaPackages) {
		//metaPackages.add(DocumentModelPackage.eINSTANCE);
		//metaPackages.add(ClassDiagramModelPackage.eINSTANCE);
	}
}
