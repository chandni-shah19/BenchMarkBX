...
/**
 * Adapted from demo used to demonstrated how to use medini QVT inside a Java application from Hajo Eichler <eichler@ikv.de>
 */
public class RunTrafo_FWD {
	 ...
	 */
	public RunTrafo_FWD(OutputStream outputStream) {
	...
	public void launch(String basePath, String targetFileRelPath, String sourceFileRelPath) {
		...
		File targetFile = new File(basePath + targetFileRelPath);
		targetFile.delete();
		
		// Load the model files
		Resource resource1 = this.getResource(basePath + sourceFileRelPath);
		Resource resource2 = this.getResource(basePath + targetFileRelPath);
