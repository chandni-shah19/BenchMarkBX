 ...
 * <ul>
 *   <li>{@link Families.impl.FamilyMemberImpl#getFamily_father <em>Family father</em>}</li>
 *   <li>{@link Families.impl.FamilyMemberImpl#getFamily_mother <em>Family mother</em>}</li>
 *   <li>{@link Families.impl.FamilyMemberImpl#getFamily_son <em>Family son</em>}</li>
 *   <li>{@link Families.impl.FamilyMemberImpl#getFamily_daughter <em>Family daughter</em>}</li>
...
public class FamilyMemberImpl extends EObjectImpl implements FamilyMember {
	...
	public Family getFamily_father() {
		if (eContainerFeatureID() != FamiliesPackage.FAMILY_MEMBER__FAMILY_FATHER)
			return null;
	...
	public NotificationChain basicSetFamily_father(Family newFamily_father, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newFamily_father, FamiliesPackage.FAMILY_MEMBER__FAMILY_FATHER,
				msgs);
		return msgs;
	}
	...
	public void setFamily_father(Family newFamily_father) {
		if (newFamily_father != eInternalContainer()
				|| (eContainerFeatureID() != FamiliesPackage.FAMILY_MEMBER__FAMILY_FATHER
			...
			if (newFamily_father != null)
				msgs = ((InternalEObject) newFamily_father).eInverseAdd(this, FamiliesPackage.FAMILY__FATHER,
						Family.class, msgs);
			msgs = basicSetFamily_father(newFamily_father, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.FAMILY_MEMBER__FAMILY_FATHER,
	...
	public Family getFamily_mother() {
		if (eContainerFeatureID() != FamiliesPackage.FAMILY_MEMBER__FAMILY_MOTHER)
			return null;
		return (Family) eContainer();
	}
	...
	public NotificationChain basicSetFamily_mother(Family newFamily_mother, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newFamily_mother, FamiliesPackage.FAMILY_MEMBER__FAMILY_MOTHER,
				msgs);
		return msgs;
	}
	...
	public void setFamily_mother(Family newFamily_mother) {
		if (newFamily_mother != eInternalContainer()
				|| (eContainerFeatureID() != FamiliesPackage.FAMILY_MEMBER__FAMILY_MOTHER
			...
			if (newFamily_mother != null)
				msgs = ((InternalEObject) newFamily_mother).eInverseAdd(this, FamiliesPackage.FAMILY__MOTHER,
						Family.class, msgs);
			msgs = basicSetFamily_mother(newFamily_mother, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.FAMILY_MEMBER__FAMILY_MOTHER,
	...
	public Family getFamily_son() {
		if (eContainerFeatureID() != FamiliesPackage.FAMILY_MEMBER__FAMILY_SON)
			return null;
		return (Family) eContainer();
	}
	...
	public NotificationChain basicSetFamily_son(Family newFamily_son, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newFamily_son, FamiliesPackage.FAMILY_MEMBER__FAMILY_SON, msgs);
		return msgs;
	}
	...
	public void setFamily_son(Family newFamily_son) {
		if (newFamily_son != eInternalContainer()
				|| (eContainerFeatureID() != FamiliesPackage.FAMILY_MEMBER__FAMILY_SON && newFamily_son != null)) {
			...
			if (newFamily_son != null)
				msgs = ((InternalEObject) newFamily_son).eInverseAdd(this, FamiliesPackage.FAMILY__SONS, Family.class,
						msgs);
			msgs = basicSetFamily_son(newFamily_son, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.FAMILY_MEMBER__FAMILY_SON,
	...
	public Family getFamily_daughter() {
		if (eContainerFeatureID() != FamiliesPackage.FAMILY_MEMBER__FAMILY_DAUGHTER)
			return null;
		return (Family) eContainer();
	}
	...
	public NotificationChain basicSetFamily_daughter(Family newFamily_daughter, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newFamily_daughter, FamiliesPackage.FAMILY_MEMBER__FAMILY_DAUGHTER,
				msgs);
		return msgs;
	}
	...
	public void setFamily_daughter(Family newFamily_daughter) {
		if (newFamily_daughter != eInternalContainer()
				|| (eContainerFeatureID() != FamiliesPackage.FAMILY_MEMBER__FAMILY_DAUGHTER
			...
			if (newFamily_daughter != null)
				msgs = ((InternalEObject) newFamily_daughter).eInverseAdd(this, FamiliesPackage.FAMILY__DAUGHTERS,
						Family.class, msgs);
			msgs = basicSetFamily_daughter(newFamily_daughter, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.FAMILY_MEMBER__FAMILY_DAUGHTER,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case FamiliesPackage.FAMILY_MEMBER__FAMILY_FATHER:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetFamily_father((Family) otherEnd, msgs);
		case FamiliesPackage.FAMILY_MEMBER__FAMILY_MOTHER:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetFamily_mother((Family) otherEnd, msgs);
		case FamiliesPackage.FAMILY_MEMBER__FAMILY_SON:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetFamily_son((Family) otherEnd, msgs);
		case FamiliesPackage.FAMILY_MEMBER__FAMILY_DAUGHTER:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
