...
public class AtHomeToWebTrafo extends SynchronizationHelper{

   public AtHomeToWebTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        AtHomeToWebTrafo helper = new AtHomeToWebTrafo();
        helper.setVerbose(true);
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new AtHomeToWebTrafo();
