...
public class MotherToFemaleImpl extends AbstractRuleImpl implements MotherToFemale {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_0(EMoflonEdge _edge_family) {
		// prepare return value
		Object[] result1_bindingAndBlack = MotherToFemaleImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_0(EMoflonEdge _edge_person) {
		// prepare return value
		Object[] result1_bindingAndBlack = MotherToFemaleImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		// prepare
		Object[] result1_bindingAndBlack = MotherToFemaleImpl
				.pattern_MotherToFemale_24_1_prepare_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
		...
		// EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = MotherToFemaleImpl.pattern_MotherToFemale_24_1_prepare_greenBF(perform_CC);
		IsApplicableRuleResult result = (IsApplicableRuleResult) result1_green[1];

		// ForEach match context
		Object[] result2_binding = MotherToFemaleImpl
				.pattern_MotherToFemale_24_2_matchcontext_bindingFFFFFBB(targetMatch, sourceMatch);
		if (result2_binding == null) {
		...
		for (Object[] result2_black : MotherToFemaleImpl.pattern_MotherToFemale_24_2_matchcontext_blackBFBBBBBB(p,
				persons, f, fm, families, sourceMatch, targetMatch)) {
			FamiliesToPersonsCorr families2persons = (FamiliesToPersonsCorr) result2_black[1];
			Object[] result2_green = MotherToFemaleImpl.pattern_MotherToFemale_24_2_matchcontext_greenBBBBBBBFB(p,
			...
			Object[] result3_bindingAndBlack = MotherToFemaleImpl
					.pattern_MotherToFemale_24_3_checkcsp_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch, p,
							families2persons, persons, f, fm, families, sourceMatch, targetMatch);
			if (result3_bindingAndBlack != null) {
				...
				Object[] result4_black = MotherToFemaleImpl
						.pattern_MotherToFemale_24_4_addtoreturnedresult_blackBB(result, isApplicableMatch);
				if (result4_black == null) {
					throw new RuntimeException(
							"Pattern matching in node [add to returned result] failed." + " Variables: " + "[result] = "
									+ result + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
				}
				MotherToFemaleImpl.pattern_MotherToFemale_24_4_addtoreturnedresult_greenBB(result, isApplicableMatch);

			} else {
			}

		}
		return MotherToFemaleImpl.pattern_MotherToFemale_24_5_expressionFB(result);
	}
	...
	public PerformRuleResult perform_CC(IsApplicableMatchCC isApplicableMatch) {
		// prepare
		Object[] result1_black = MotherToFemaleImpl.pattern_MotherToFemale_27_1_prepare_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare] failed." + " Variables: " + "[this] = " + this + ".");
		}
		...
		Object[] result2_bindingAndBlack = MotherToFemaleImpl
				.pattern_MotherToFemale_27_2_createcorrespondencelinks_bindingAndBlackFFFFFFB(isApplicableMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result2_green = MotherToFemaleImpl.pattern_MotherToFemale_27_2_createcorrespondencelinks_greenBBFF(p,
				fm);
		...
		return MotherToFemaleImpl.pattern_MotherToFemale_27_3_expressionFB(result);
	}
	...
	public boolean checkDEC_FWD(Family f, FamilyMember fm, Families families) {// match tgg pattern
		Object[] result1_black = MotherToFemaleImpl.pattern_MotherToFemale_28_1_matchtggpattern_blackBBB(f, fm,
				families);
		if (result1_black != null) {
	...
	public boolean checkDEC_BWD(Female p, Persons persons) {// match tgg pattern
		Object[] result1_black = MotherToFemaleImpl.pattern_MotherToFemale_29_1_matchtggpattern_blackBB(p, persons);
		if (result1_black != null) {
			return MotherToFemaleImpl.pattern_MotherToFemale_29_2_expressionF();
		} else {
			return MotherToFemaleImpl.pattern_MotherToFemale_29_3_expressionF();
		}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		// create result
		Object[] result1_black = MotherToFemaleImpl.pattern_MotherToFemale_30_1_createresult_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [create result] failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = MotherToFemaleImpl.pattern_MotherToFemale_30_1_createresult_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach is applicable core
		for (Object[] result2_black : MotherToFemaleImpl
				.pattern_MotherToFemale_30_2_isapplicablecore_blackFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			// solve CSP
			Object[] result3_bindingAndBlack = MotherToFemaleImpl
					.pattern_MotherToFemale_30_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch,
			...
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// check CSP
			if (MotherToFemaleImpl.pattern_MotherToFemale_30_4_checkCSP_expressionFBB(this, csp)) {
				// check nacs
				Object[] result5_black = MotherToFemaleImpl
						.pattern_MotherToFemale_30_5_checknacs_blackBBB(families2persons, persons, families);
				if (result5_black != null) {

					// perform
					Object[] result6_black = MotherToFemaleImpl.pattern_MotherToFemale_30_6_perform_blackBBBB(
							families2persons, persons, families, ruleResult);
					if (result6_black == null) {
					...
					MotherToFemaleImpl.pattern_MotherToFemale_30_6_perform_greenFBFFFBBB(persons, families, ruleResult,
							csp);
		...
		return MotherToFemaleImpl.pattern_MotherToFemale_30_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MOTHER_TO_FEMALE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_0__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_0((EMoflonEdge) arguments.get(0));
		case RulesPackage.MOTHER_TO_FEMALE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_0__EMOFLONEDGE:
		...
		case RulesPackage.MOTHER_TO_FEMALE___IS_APPLICABLE_SOLVE_CSP_CC__ISAPPLICABLEMATCHCC_FEMALE_FAMILIESTOPERSONSCORR_PERSONS_FAMILY_FAMILYMEMBER_FAMILIES_MATCH_MATCH:
		...
		case RulesPackage.MOTHER_TO_FEMALE___PERFORM_CC__ISAPPLICABLEMATCHCC:
	...
	public static final Object[] pattern_MotherToFemale_20_2_testcorematchandDECs_black_nac_0BB(FamilyMember fm,
			Family f) {
		Family __DEC_fm_family_father_135890 = fm.getFamily_father();
		if (__DEC_fm_family_father_135890 != null) {
			if (!f.equals(__DEC_fm_family_father_135890)) {
	...
	public static final Object[] pattern_MotherToFemale_20_2_testcorematchandDECs_black_nac_1BB(FamilyMember fm,
			Family f) {
		Family __DEC_fm_family_son_582070 = fm.getFamily_son();
		if (__DEC_fm_family_son_582070 != null) {
			if (!f.equals(__DEC_fm_family_son_582070)) {
				return new Object[] { fm, f };
			}
		}
	...
	public static final Object[] pattern_MotherToFemale_20_2_testcorematchandDECs_black_nac_2BB(FamilyMember fm,
			Family f) {
		Family __DEC_fm_family_daughter_939948 = fm.getFamily_daughter();
		if (__DEC_fm_family_daughter_939948 != null) {
			if (!f.equals(__DEC_fm_family_daughter_939948)) {
				return new Object[] { fm, f };
			}
		}
	...
	public static final Object[] pattern_MotherToFemale_24_1_prepare_bindingFB(MotherToFemale _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
			return new Object[] { __eClass, _this };
	...
	public static final Object[] pattern_MotherToFemale_24_1_prepare_blackFBB(EClass __eClass, MotherToFemale _this) {
	...
	public static final Object[] pattern_MotherToFemale_24_1_prepare_bindingAndBlackFFB(MotherToFemale _this) {
		Object[] result_pattern_MotherToFemale_24_1_prepare_binding = pattern_MotherToFemale_24_1_prepare_bindingFB(
				_this);
		if (result_pattern_MotherToFemale_24_1_prepare_binding != null) {
			EClass __eClass = (EClass) result_pattern_MotherToFemale_24_1_prepare_binding[0];

			Object[] result_pattern_MotherToFemale_24_1_prepare_black = pattern_MotherToFemale_24_1_prepare_blackFBB(
					__eClass, _this);
			if (result_pattern_MotherToFemale_24_1_prepare_black != null) {
				EOperation perform_CC = (EOperation) result_pattern_MotherToFemale_24_1_prepare_black[0];
	...
	public static final Object[] pattern_MotherToFemale_24_1_prepare_greenBF(EOperation perform_CC) {
		IsApplicableRuleResult result = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		result.setPerformOperation(perform_CC);
		return new Object[] { perform_CC, result };
	}

	public static final Object[] pattern_MotherToFemale_24_2_matchcontext_bindingFFFFFBB(Match targetMatch,
			Match sourceMatch) {
	...
	public static final Iterable<Object[]> pattern_MotherToFemale_24_2_matchcontext_blackBFBBBBBB(Female p,
	...
	public static final Object[] pattern_MotherToFemale_24_2_matchcontext_greenBBBBBBBFB(Female p,
			FamiliesToPersonsCorr families2persons, Persons persons, Family f, FamilyMember fm, Families families,
	...
	public static final Object[] pattern_MotherToFemale_24_3_checkcsp_bindingFBBBBBBBBBB(MotherToFemale _this,
	...
	public static final Object[] pattern_MotherToFemale_24_3_checkcsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_MotherToFemale_24_3_checkcsp_bindingAndBlackFBBBBBBBBBB(MotherToFemale _this,
			IsApplicableMatchCC isApplicableMatch, Female p, FamiliesToPersonsCorr families2persons, Persons persons,
			Family f, FamilyMember fm, Families families, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_MotherToFemale_24_3_checkcsp_binding = pattern_MotherToFemale_24_3_checkcsp_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, p, families2persons, persons, f, fm, families, sourceMatch, targetMatch);
		if (result_pattern_MotherToFemale_24_3_checkcsp_binding != null) {
			CSP csp = (CSP) result_pattern_MotherToFemale_24_3_checkcsp_binding[0];

			Object[] result_pattern_MotherToFemale_24_3_checkcsp_black = pattern_MotherToFemale_24_3_checkcsp_blackB(
					csp);
			if (result_pattern_MotherToFemale_24_3_checkcsp_black != null) {
	...
	public static final Object[] pattern_MotherToFemale_24_4_addtoreturnedresult_blackBB(IsApplicableRuleResult result,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_MotherToFemale_24_4_addtoreturnedresult_greenBB(IsApplicableRuleResult result,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_MotherToFemale_24_5_expressionFB(IsApplicableRuleResult result) {
		IsApplicableRuleResult _result = result;
		return _result;
	}

	public static final Object[] pattern_MotherToFemale_27_1_prepare_blackB(MotherToFemale _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_MotherToFemale_27_2_createcorrespondencelinks_bindingFFFFFFB(
	...
	public static final Object[] pattern_MotherToFemale_27_2_createcorrespondencelinks_blackBBBBBBB(Female p,
			FamiliesToPersonsCorr families2persons, Persons persons, Family f, FamilyMember fm, Families families,
			IsApplicableMatchCC isApplicableMatch) {
		if (families.getFamily().contains(f)) {
			if (persons.getPerson().contains(p)) {
	...
	public static final Object[] pattern_MotherToFemale_27_2_createcorrespondencelinks_bindingAndBlackFFFFFFB(
			IsApplicableMatchCC isApplicableMatch) {
		Object[] result_pattern_MotherToFemale_27_2_createcorrespondencelinks_binding = pattern_MotherToFemale_27_2_createcorrespondencelinks_bindingFFFFFFB(
				isApplicableMatch);
		if (result_pattern_MotherToFemale_27_2_createcorrespondencelinks_binding != null) {
			Female p = (Female) result_pattern_MotherToFemale_27_2_createcorrespondencelinks_binding[0];
			FamiliesToPersonsCorr families2persons = (FamiliesToPersonsCorr) result_pattern_MotherToFemale_27_2_createcorrespondencelinks_binding[1];
			Persons persons = (Persons) result_pattern_MotherToFemale_27_2_createcorrespondencelinks_binding[2];
			Family f = (Family) result_pattern_MotherToFemale_27_2_createcorrespondencelinks_binding[3];
			FamilyMember fm = (FamilyMember) result_pattern_MotherToFemale_27_2_createcorrespondencelinks_binding[4];
			Families families = (Families) result_pattern_MotherToFemale_27_2_createcorrespondencelinks_binding[5];

			Object[] result_pattern_MotherToFemale_27_2_createcorrespondencelinks_black = pattern_MotherToFemale_27_2_createcorrespondencelinks_blackBBBBBBB(
					p, families2persons, persons, f, fm, families, isApplicableMatch);
			if (result_pattern_MotherToFemale_27_2_createcorrespondencelinks_black != null) {
	...
	public static final Object[] pattern_MotherToFemale_27_2_createcorrespondencelinks_greenBBFF(Female p,
			FamilyMember fm) {
	...
	public static final PerformRuleResult pattern_MotherToFemale_27_3_expressionFB(PerformRuleResult result) {
		PerformRuleResult _result = result;
		return _result;
	}

	public static final Object[] pattern_MotherToFemale_28_1_matchtggpattern_black_nac_0BB(FamilyMember fm, Family f) {
		Family __DEC_fm_family_father_241222 = fm.getFamily_father();
		if (__DEC_fm_family_father_241222 != null) {
			if (!f.equals(__DEC_fm_family_father_241222)) {
				return new Object[] { fm, f };
			}
		}
	...
	public static final Object[] pattern_MotherToFemale_28_1_matchtggpattern_black_nac_1BB(FamilyMember fm, Family f) {
		Family __DEC_fm_family_son_378558 = fm.getFamily_son();
		if (__DEC_fm_family_son_378558 != null) {
			if (!f.equals(__DEC_fm_family_son_378558)) {
				return new Object[] { fm, f };
			}
		}
	...
	public static final Object[] pattern_MotherToFemale_28_1_matchtggpattern_black_nac_2BB(FamilyMember fm, Family f) {
		Family __DEC_fm_family_daughter_42392 = fm.getFamily_daughter();
		if (__DEC_fm_family_daughter_42392 != null) {
			if (!f.equals(__DEC_fm_family_daughter_42392)) {
				return new Object[] { fm, f };
			}
		}
	...
	public static final Object[] pattern_MotherToFemale_28_1_matchtggpattern_black_nac_3BB(FamilyMember fm, Family f) {
		if (f.equals(fm.getFamily_father())) {
			return new Object[] { fm, f };
		}
		return null;
	...
	public static final Object[] pattern_MotherToFemale_28_1_matchtggpattern_black_nac_4BB(FamilyMember fm, Family f) {
		if (f.equals(fm.getFamily_son())) {
			return new Object[] { fm, f };
		}
		return null;
	...
	public static final Object[] pattern_MotherToFemale_28_1_matchtggpattern_black_nac_5BB(FamilyMember fm, Family f) {
		if (f.equals(fm.getFamily_daughter())) {
			return new Object[] { fm, f };
		}
		return null;
	...
	public static final Object[] pattern_MotherToFemale_28_1_matchtggpattern_blackBBB(Family f, FamilyMember fm,
			Families families) {
		if (families.getFamily().contains(f)) {
			if (f.equals(fm.getFamily_mother())) {
				if (pattern_MotherToFemale_28_1_matchtggpattern_black_nac_0BB(fm, f) == null) {
					if (pattern_MotherToFemale_28_1_matchtggpattern_black_nac_1BB(fm, f) == null) {
						if (pattern_MotherToFemale_28_1_matchtggpattern_black_nac_2BB(fm, f) == null) {
							if (pattern_MotherToFemale_28_1_matchtggpattern_black_nac_3BB(fm, f) == null) {
								if (pattern_MotherToFemale_28_1_matchtggpattern_black_nac_4BB(fm, f) == null) {
									if (pattern_MotherToFemale_28_1_matchtggpattern_black_nac_5BB(fm, f) == null) {
	...
	public static final Object[] pattern_MotherToFemale_29_1_matchtggpattern_blackBB(Female p, Persons persons) {
		if (persons.getPerson().contains(p)) {
	...
	public static final boolean pattern_MotherToFemale_29_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_MotherToFemale_29_3_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_MotherToFemale_30_1_createresult_blackB(MotherToFemale _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_MotherToFemale_30_1_createresult_greenFF() {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_MotherToFemale_30_2_isapplicablecore_black_nac_0BB(
	...
	public static final Object[] pattern_MotherToFemale_30_2_isapplicablecore_black_nac_1BB(
	...
	public static final Object[] pattern_MotherToFemale_30_2_isapplicablecore_black_nac_2BB(
	...
	public static final Iterable<Object[]> pattern_MotherToFemale_30_2_isapplicablecore_blackFFFFBB(
			...
			for (EObject tmpFamilies2persons : families2personsList.getEntryObjects()) {
				if (tmpFamilies2persons instanceof FamiliesToPersonsCorr) {
					...
					if (families != null) {
						Persons persons = families2persons.getTarget();
						if (persons != null) {
							if (pattern_MotherToFemale_30_2_isapplicablecore_black_nac_0BB(ruleResult,
									families2persons) == null) {
								if (pattern_MotherToFemale_30_2_isapplicablecore_black_nac_1BB(ruleResult,
										families) == null) {
									if (pattern_MotherToFemale_30_2_isapplicablecore_black_nac_2BB(ruleResult,
											persons) == null) {
	...
	public static final Object[] pattern_MotherToFemale_30_3_solveCSP_bindingFBBBBBB(MotherToFemale _this,
	...
	public static final Object[] pattern_MotherToFemale_30_3_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_MotherToFemale_30_3_solveCSP_bindingAndBlackFBBBBBB(MotherToFemale _this,
			IsApplicableMatch isApplicableMatch, FamiliesToPersonsCorr families2persons, Persons persons,
			Families families, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_MotherToFemale_30_3_solveCSP_binding = pattern_MotherToFemale_30_3_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, families2persons, persons, families, ruleResult);
		if (result_pattern_MotherToFemale_30_3_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_MotherToFemale_30_3_solveCSP_binding[0];

			Object[] result_pattern_MotherToFemale_30_3_solveCSP_black = pattern_MotherToFemale_30_3_solveCSP_blackB(
					csp);
			if (result_pattern_MotherToFemale_30_3_solveCSP_black != null) {
	...
	public static final boolean pattern_MotherToFemale_30_4_checkCSP_expressionFBB(MotherToFemale _this, CSP csp) {
		boolean _localVariable_0 = _this.generateModel_checkCsp_BWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_MotherToFemale_30_5_checknacs_blackBBB(FamiliesToPersonsCorr families2persons,
			Persons persons, Families families) {
		return new Object[] { families2persons, persons, families };
	}

	public static final Object[] pattern_MotherToFemale_30_6_perform_blackBBBB(FamiliesToPersonsCorr families2persons,
	...
	public static final Object[] pattern_MotherToFemale_30_6_perform_greenFBFFFBBB(Persons persons, Families families,
	...
	public static final ModelgeneratorRuleResult pattern_MotherToFemale_30_7_expressionFB(
