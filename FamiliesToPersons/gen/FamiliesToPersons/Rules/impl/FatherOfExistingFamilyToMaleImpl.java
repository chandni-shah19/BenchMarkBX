...
import FamiliesToPersons.Rules.FatherOfExistingFamilyToMale;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Father Of Existing Family To Male</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class FatherOfExistingFamilyToMaleImpl extends AbstractRuleImpl implements FatherOfExistingFamilyToMale {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected FatherOfExistingFamilyToMaleImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getFatherOfExistingFamilyToMale();
	}
	...
	public boolean isAppropriate_FWD(Match match, Family f, FamilyMember fm, Families families) {
		...
		Object[] result1_black = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_0_1_initialbindings_blackBBBBB(this, match, f, fm, families);
		...
		Object[] result2_bindingAndBlack = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_bindingAndBlackFBBBBB(this, match, f, fm, families);
		...
		// Check CSP
		if (FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_0_3_CheckCSP_expressionFBB(this,
				csp)) {

			// collect elements to be translated
			Object[] result4_black = FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_0_4_collectelementstobetranslated_blackBBBB(match, f, fm,
							families);
			...
			FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_0_4_collectelementstobetranslated_greenBBBFF(match, f, fm);
			// EMoflonEdge fm__f____family_father = (EMoflonEdge) result4_green[3];
			// EMoflonEdge f__fm____father = (EMoflonEdge) result4_green[4];

			// collect context elements
			Object[] result5_black = FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_0_5_collectcontextelements_blackBBBB(match, f, fm, families);
			...
			FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_0_5_collectcontextelements_greenBBBF(match, f, families);
			// EMoflonEdge families__f____family = (EMoflonEdge) result5_green[3];

			// register objects to match
			FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_0_6_registerobjectstomatch_expressionBBBBB(this, match, f, fm,
							families);
			return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_0_7_expressionF();
		} else {
			return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_bindingAndBlackFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_greenFBFBB(persons, fm, csp);
		Male p = (Male) result1_green[0];
		FamilyMemberToPerson familyMember2Persons = (FamilyMemberToPerson) result1_green[2];

		// collect translated elements
		Object[] result2_black = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_1_2_collecttranslatedelements_blackBBB(p, familyMember2Persons,
						fm);
		...
		Object[] result2_green = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_1_2_collecttranslatedelements_greenFBBB(p, familyMember2Persons,
						fm);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, p,
		...
		FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		// register objects
		FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_1_5_registerobjects_expressionBBBBBBBBB(
				this, ruleresult, p, families2persons, persons, familyMember2Persons, f, fm, families);
		return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
		...
		Object[] result1_green = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_2_2_corematch_bindingFFFB(match);
		...
		for (Object[] result2_black : FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_2_2_corematch_blackFFBBBB(f, fm, families, match)) {
			FamiliesToPersonsCorr families2persons = (FamiliesToPersonsCorr) result2_black[0];
			Persons persons = (Persons) result2_black[1];
			// ForEach find context
			for (Object[] result3_black : FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_2_3_findcontext_blackBBBBB(families2persons, persons, f, fm,
							families)) {
				Object[] result3_green = FatherOfExistingFamilyToMaleImpl
						.pattern_FatherOfExistingFamilyToMale_2_3_findcontext_greenBBBBBFFFFFF(families2persons,
				...
				Object[] result4_bindingAndBlack = FatherOfExistingFamilyToMaleImpl
						.pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_bindingAndBlackFBBBBBBB(this,
				...
				// check CSP
				if (FatherOfExistingFamilyToMaleImpl
						.pattern_FatherOfExistingFamilyToMale_2_5_checkCSP_expressionFBB(this, csp)) {

					// add match to rule result
					Object[] result6_black = FatherOfExistingFamilyToMaleImpl
							.pattern_FatherOfExistingFamilyToMale_2_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					...
					FatherOfExistingFamilyToMaleImpl
							.pattern_FatherOfExistingFamilyToMale_2_6_addmatchtoruleresult_greenBB(ruleresult,
									isApplicableMatch);
		...
		return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_2_7_expressionFB(ruleresult);
	}
	...
	public boolean isAppropriate_BWD(Match match, Male p, Persons persons) {
		// initial bindings
		Object[] result1_black = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_10_1_initialbindings_blackBBBB(this, match, p, persons);
		if (result1_black == null) {
			throw new RuntimeException(
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_bindingAndBlackFBBBB(this, match, p, persons);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [Solve CSP] failed." + " Variables: " + "[this] = "
		...
		CSP csp = (CSP) result2_bindingAndBlack[0];
		// Check CSP
		if (FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_10_3_CheckCSP_expressionFBB(this,
				csp)) {

			// collect elements to be translated
			Object[] result4_black = FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_10_4_collectelementstobetranslated_blackBBB(match, p,
							persons);
			if (result4_black == null) {
				throw new RuntimeException(
			...
			FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_10_4_collectelementstobetranslated_greenBBBF(match, p,
							persons);
			// EMoflonEdge persons__p____person = (EMoflonEdge) result4_green[3];

			// collect context elements
			Object[] result5_black = FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_10_5_collectcontextelements_blackBBB(match, p, persons);
			if (result5_black == null) {
				throw new RuntimeException(
			...
			FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_10_5_collectcontextelements_greenBB(match, persons);

			// register objects to match
			FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_10_6_registerobjectstomatch_expressionBBBB(this, match, p,
							persons);
			return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_10_7_expressionF();
		} else {
			return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_bindingAndBlackFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [perform transformation] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_greenBFBFB(p, f, csp);
		...
		// collect translated elements
		Object[] result2_black = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_11_2_collecttranslatedelements_blackBBB(p, familyMember2Persons,
						fm);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [collect translated elements] failed." + " Variables: " + "[p] = " + p
		...
		Object[] result2_green = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_11_2_collecttranslatedelements_greenFBBB(p, familyMember2Persons,
						fm);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_11_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, p,
						families2persons, persons, familyMember2Persons, f, fm, families);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[p] = " + p + ", " + "[families2persons] = "
		...
		FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_11_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, p, persons, familyMember2Persons, f, fm);
		// EMoflonEdge persons__p____person = (EMoflonEdge) result3_green[6];
		// EMoflonEdge familyMember2Persons__fm____source = (EMoflonEdge) result3_green[7];
		// EMoflonEdge familyMember2Persons__p____target = (EMoflonEdge) result3_green[8];
		...
		// perform postprocessing story node is empty
		// register objects
		FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_11_5_registerobjects_expressionBBBBBBBBB(
				this, ruleresult, p, families2persons, persons, familyMember2Persons, f, fm, families);
		return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_11_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		// prepare return value
		Object[] result1_bindingAndBlack = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [prepare return value] failed." + " Variables: "
					+ "[this] = " + this + ".");
		}
		...
		// EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_12_2_corematch_bindingFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_12_2_corematch_blackBFBFB(p, persons, match)) {
			FamiliesToPersonsCorr families2persons = (FamiliesToPersonsCorr) result2_black[1];
			Families families = (Families) result2_black[3];
			// ForEach find context
			for (Object[] result3_black : FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_12_3_findcontext_blackBBBFB(p, families2persons, persons,
							families)) {
				Family f = (Family) result3_black[3];
				Object[] result3_green = FatherOfExistingFamilyToMaleImpl
						.pattern_FatherOfExistingFamilyToMale_12_3_findcontext_greenBBBBBFFFFF(p, families2persons,
								persons, f, families);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				// EMoflonEdge families__f____family = (EMoflonEdge) result3_green[6];
				...
				// solve CSP
				Object[] result4_bindingAndBlack = FatherOfExistingFamilyToMaleImpl
						.pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_bindingAndBlackFBBBBBBB(this,
				...
				// check CSP
				if (FatherOfExistingFamilyToMaleImpl
						.pattern_FatherOfExistingFamilyToMale_12_5_checkCSP_expressionFBB(this, csp)) {

					// add match to rule result
					Object[] result6_black = FatherOfExistingFamilyToMaleImpl
							.pattern_FatherOfExistingFamilyToMale_12_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching in node [add match to rule result] failed."
								+ " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[isApplicableMatch] = "
					...
					FatherOfExistingFamilyToMaleImpl
							.pattern_FatherOfExistingFamilyToMale_12_6_addmatchtoruleresult_greenBB(ruleresult,
									isApplicableMatch);
		...
		return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_12_7_expressionFB(ruleresult);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_4(EMoflonEdge _edge_family_father) {
		...
		Object[] result1_green = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_blackFFFB(_edge_family_father)) {
			Family f = (Family) result2_black[0];
			FamilyMember fm = (FamilyMember) result2_black[1];
			Families families = (Families) result2_black[2];
			Object[] result2_green = FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
							this, match, f, fm, families)) {
				// Ensure that the correct types of elements are matched
				if (FatherOfExistingFamilyToMaleImpl
						.pattern_FatherOfExistingFamilyToMale_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = FatherOfExistingFamilyToMaleImpl
							.pattern_FatherOfExistingFamilyToMale_20_5_Addmatchtoruleresult_blackBBBB(match,
					...
					FatherOfExistingFamilyToMaleImpl
							.pattern_FatherOfExistingFamilyToMale_20_5_Addmatchtoruleresult_greenBBBB(match,
									__performOperation, __result, isApplicableCC);
		...
		return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_20_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_4(EMoflonEdge _edge_person) {
		...
		EOperation isApplicableCC = (EOperation) result1_bindingAndBlack[3];
		Object[] result1_green = FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : FatherOfExistingFamilyToMaleImpl
				.pattern_FatherOfExistingFamilyToMale_21_2_testcorematchandDECs_blackFFB(_edge_person)) {
			Male p = (Male) result2_black[0];
			Persons persons = (Persons) result2_black[1];
			Object[] result2_green = FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_21_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (FatherOfExistingFamilyToMaleImpl
					.pattern_FatherOfExistingFamilyToMale_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
							this, match, p, persons)) {
				// Ensure that the correct types of elements are matched
				if (FatherOfExistingFamilyToMaleImpl
						.pattern_FatherOfExistingFamilyToMale_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = FatherOfExistingFamilyToMaleImpl
							.pattern_FatherOfExistingFamilyToMale_21_5_Addmatchtoruleresult_blackBBBB(match,
									__performOperation, __result, isApplicableCC);
					if (result5_black == null) {
						throw new RuntimeException("Pattern matching in node [Add match to rule result] failed."
								+ " Variables: " + "[match] = " + match + ", " + "[__performOperation] = "
					...
					FatherOfExistingFamilyToMaleImpl
							.pattern_FatherOfExistingFamilyToMale_21_5_Addmatchtoruleresult_greenBBBB(match,
									__performOperation, __result, isApplicableCC);
		...
		return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_21_6_expressionFB(__result);
	}
	...
	public boolean checkDEC_FWD(Family f, FamilyMember fm, Families families) {// match tgg pattern
		...
		if (result1_black != null) {
			...
			return FatherOfExistingFamilyToMaleImpl.pattern_FatherOfExistingFamilyToMale_28_3_expressionF();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPROPRIATE_FWD__MATCH_FAMILY_FAMILYMEMBER_FAMILIES:
		...
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___PERFORM_FWD__ISAPPLICABLEMATCH:
			return perform_FWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPLICABLE_FWD__MATCH:
			return isApplicable_FWD((Match) arguments.get(0));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_FAMILY_FAMILYMEMBER_FAMILIES:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (Family) arguments.get(1),
					(FamilyMember) arguments.get(2), (Families) arguments.get(3));
			return null;
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_FAMILY_FAMILYMEMBER_FAMILIES:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (Family) arguments.get(1),
					(FamilyMember) arguments.get(2), (Families) arguments.get(3));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_FAMILIESTOPERSONSCORR_PERSONS_FAMILY_FAMILYMEMBER_FAMILIES:
		...
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPLICABLE_CHECK_CSP_FWD__CSP:
			return isApplicable_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
			registerObjects_FWD((PerformRuleResult) arguments.get(0), (EObject) arguments.get(1),
					(EObject) arguments.get(2), (EObject) arguments.get(3), (EObject) arguments.get(4),
					(EObject) arguments.get(5), (EObject) arguments.get(6), (EObject) arguments.get(7));
			return null;
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___CHECK_TYPES_FWD__MATCH:
			return checkTypes_FWD((Match) arguments.get(0));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPROPRIATE_BWD__MATCH_MALE_PERSONS:
			return isAppropriate_BWD((Match) arguments.get(0), (Male) arguments.get(1), (Persons) arguments.get(2));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___PERFORM_BWD__ISAPPLICABLEMATCH:
			return perform_BWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPLICABLE_BWD__MATCH:
			return isApplicable_BWD((Match) arguments.get(0));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_MALE_PERSONS:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (Male) arguments.get(1), (Persons) arguments.get(2));
			return null;
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_MALE_PERSONS:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (Male) arguments.get(1),
					(Persons) arguments.get(2));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MALE_FAMILIESTOPERSONSCORR_PERSONS_FAMILY_FAMILIES:
		...
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___IS_APPLICABLE_CHECK_CSP_BWD__CSP:
			return isApplicable_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___CHECK_DEC_BWD__MALE_PERSONS:
			return checkDEC_BWD((Male) arguments.get(0), (Persons) arguments.get(1));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___GENERATE_MODEL__RULEENTRYCONTAINER_FAMILIESTOPERSONSCORR:
			return generateModel((RuleEntryContainer) arguments.get(0), (FamiliesToPersonsCorr) arguments.get(1));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_FAMILIESTOPERSONSCORR_PERSONS_FAMILY_FAMILIES_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(FamiliesToPersonsCorr) arguments.get(1), (Persons) arguments.get(2), (Family) arguments.get(3),
					(Families) arguments.get(4), (ModelgeneratorRuleResult) arguments.get(5));
		case RulesPackage.FATHER_OF_EXISTING_FAMILY_TO_MALE___GENERATE_MODEL_CHECK_CSP_BWD__CSP:
			return generateModel_checkCsp_BWD((CSP) arguments.get(0));
		}
		return super.eInvoke(operationID, arguments);
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_0_1_initialbindings_blackBBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Family f, FamilyMember fm, Families families) {
		return new Object[] { _this, match, f, fm, families };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_bindingFBBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Family f, FamilyMember fm, Families families) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_bindingAndBlackFBBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Family f, FamilyMember fm, Families families) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_binding = pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_bindingFBBBBB(
				_this, match, f, fm, families);
		if (result_pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_binding[0];

			Object[] result_pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_black = pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_blackB(
					csp);
			if (result_pattern_FatherOfExistingFamilyToMale_0_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_FatherOfExistingFamilyToMale_0_3_CheckCSP_expressionFBB(
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_0_4_collectelementstobetranslated_blackBBBB(
			Match match, Family f, FamilyMember fm, Families families) {
		return new Object[] { match, f, fm, families };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_0_4_collectelementstobetranslated_greenBBBFF(
		...
		return new Object[] { match, f, fm, fm__f____family_father, f__fm____father };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_0_5_collectcontextelements_blackBBBB(Match match,
			Family f, FamilyMember fm, Families families) {
		return new Object[] { match, f, fm, families };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_0_5_collectcontextelements_greenBBBF(Match match,
	...
	public static final void pattern_FatherOfExistingFamilyToMale_0_6_registerobjectstomatch_expressionBBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Family f, FamilyMember fm, Families families) {
		_this.registerObjectsToMatch_FWD(match, f, fm, families);

	}

	public static final boolean pattern_FatherOfExistingFamilyToMale_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FatherOfExistingFamilyToMale_0_8_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_bindingFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_blackBBBBBFBB(
			FamiliesToPersonsCorr families2persons, Persons persons, Family f, FamilyMember fm, Families families,
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_bindingAndBlackFFFFFFBB(
			FatherOfExistingFamilyToMale _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_binding = pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_bindingFFFFFB(
				isApplicableMatch);
		if (result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_binding != null) {
			FamiliesToPersonsCorr families2persons = (FamiliesToPersonsCorr) result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_binding[0];
			Persons persons = (Persons) result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_binding[1];
			Family f = (Family) result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_binding[2];
			FamilyMember fm = (FamilyMember) result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_binding[3];
			Families families = (Families) result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_binding[4];

			Object[] result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_black = pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_blackBBBBBFBB(
					families2persons, persons, f, fm, families, _this, isApplicableMatch);
			if (result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_black[5];
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_1_1_performtransformation_greenFBFBB(
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_1_2_collecttranslatedelements_blackBBB(Male p,
			FamilyMemberToPerson familyMember2Persons, FamilyMember fm) {
		return new Object[] { p, familyMember2Persons, fm };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_1_2_collecttranslatedelements_greenFBBB(Male p,
			FamilyMemberToPerson familyMember2Persons, FamilyMember fm) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_1_3_bookkeepingforedges_blackBBBBBBBB(
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		EMoflonEdge fm__f____family_father = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge f__fm____father = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		String ruleresult_ruleName_prime = "FatherOfExistingFamilyToMale";
		...
		return new Object[] { ruleresult, p, persons, familyMember2Persons, f, fm, persons__p____person,
				familyMember2Persons__fm____source, familyMember2Persons__p____target, fm__f____family_father,
				f__fm____father };
	}

	public static final void pattern_FatherOfExistingFamilyToMale_1_5_registerobjects_expressionBBBBBBBBB(
			FatherOfExistingFamilyToMale _this, PerformRuleResult ruleresult, EObject p, EObject families2persons,
	...
	public static final PerformRuleResult pattern_FatherOfExistingFamilyToMale_1_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_bindingFB(
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_blackFBB(EClass eClass,
			FatherOfExistingFamilyToMale _this) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_bindingAndBlackFFB(
			FatherOfExistingFamilyToMale _this) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_binding = pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_black = pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
		String ruleresult_rule_prime = "FatherOfExistingFamilyToMale";
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_FatherOfExistingFamilyToMale_2_2_corematch_blackFFBBBB(Family f,
	...
	public static final Iterable<Object[]> pattern_FatherOfExistingFamilyToMale_2_3_findcontext_blackBBBBB(
			FamiliesToPersonsCorr families2persons, Persons persons, Family f, FamilyMember fm, Families families) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_3_findcontext_greenBBBBBFFFFFF(
			FamiliesToPersonsCorr families2persons, Persons persons, Family f, FamilyMember fm, Families families) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_bindingAndBlackFBBBBBBB(
			FatherOfExistingFamilyToMale _this, IsApplicableMatch isApplicableMatch,
			FamiliesToPersonsCorr families2persons, Persons persons, Family f, FamilyMember fm, Families families) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_binding = pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, families2persons, persons, f, fm, families);
		if (result_pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_binding[0];

			Object[] result_pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_black = pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_blackB(
					csp);
			if (result_pattern_FatherOfExistingFamilyToMale_2_4_solveCSP_black != null) {
	...
	public static final boolean pattern_FatherOfExistingFamilyToMale_2_5_checkCSP_expressionFBB(
			FatherOfExistingFamilyToMale _this, CSP csp) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_FatherOfExistingFamilyToMale_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_10_1_initialbindings_blackBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Male p, Persons persons) {
		return new Object[] { _this, match, p, persons };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_bindingFBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Male p, Persons persons) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_bindingAndBlackFBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Male p, Persons persons) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_binding = pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_bindingFBBBB(
				_this, match, p, persons);
		if (result_pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_binding[0];

			Object[] result_pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_black = pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_blackB(
					csp);
			if (result_pattern_FatherOfExistingFamilyToMale_10_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_FatherOfExistingFamilyToMale_10_3_CheckCSP_expressionFBB(
			FatherOfExistingFamilyToMale _this, CSP csp) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_10_4_collectelementstobetranslated_blackBBB(
			Match match, Male p, Persons persons) {
		return new Object[] { match, p, persons };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_10_4_collectelementstobetranslated_greenBBBF(
			Match match, Male p, Persons persons) {
		EMoflonEdge persons__p____person = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_10_5_collectcontextelements_blackBBB(Match match,
			Male p, Persons persons) {
		return new Object[] { match, p, persons };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_10_5_collectcontextelements_greenBB(Match match,
			Persons persons) {
		match.getContextNodes().add(persons);
		return new Object[] { match, persons };
	}

	public static final void pattern_FatherOfExistingFamilyToMale_10_6_registerobjectstomatch_expressionBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Male p, Persons persons) {
		_this.registerObjectsToMatch_BWD(match, p, persons);

	}

	public static final boolean pattern_FatherOfExistingFamilyToMale_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FatherOfExistingFamilyToMale_10_8_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_bindingFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_blackBBBBBFBB(Male p,
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_bindingAndBlackFFFFFFBB(
			FatherOfExistingFamilyToMale _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_binding = pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_bindingFFFFFB(
				isApplicableMatch);
		if (result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_binding != null) {
			Male p = (Male) result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_binding[0];
			FamiliesToPersonsCorr families2persons = (FamiliesToPersonsCorr) result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_binding[1];
			Persons persons = (Persons) result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_binding[2];
			Family f = (Family) result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_binding[3];
			Families families = (Families) result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_binding[4];

			Object[] result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_black = pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_blackBBBBBFBB(
					p, families2persons, persons, f, families, _this, isApplicableMatch);
			if (result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_black[5];
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_11_1_performtransformation_greenBFBFB(Male p,
			Family f, CSP csp) {
		FamilyMemberToPerson familyMember2Persons = FamiliesToPersonsFactory.eINSTANCE.createFamilyMemberToPerson();
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_11_2_collecttranslatedelements_blackBBB(Male p,
			FamilyMemberToPerson familyMember2Persons, FamilyMember fm) {
		return new Object[] { p, familyMember2Persons, fm };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_11_2_collecttranslatedelements_greenFBBB(Male p,
			FamilyMemberToPerson familyMember2Persons, FamilyMember fm) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_11_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject p, EObject families2persons, EObject persons,
			EObject familyMember2Persons, EObject f, EObject fm, EObject families) {
		if (!p.equals(persons)) {
			if (!families2persons.equals(p)) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_11_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject p, EObject persons, EObject familyMember2Persons, EObject f,
			EObject fm) {
		EMoflonEdge persons__p____person = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge familyMember2Persons__fm____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_FatherOfExistingFamilyToMale_11_5_registerobjects_expressionBBBBBBBBB(
			FatherOfExistingFamilyToMale _this, PerformRuleResult ruleresult, EObject p, EObject families2persons,
			EObject persons, EObject familyMember2Persons, EObject f, EObject fm, EObject families) {
	...
	public static final PerformRuleResult pattern_FatherOfExistingFamilyToMale_11_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_bindingFB(
			FatherOfExistingFamilyToMale _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_blackFBB(EClass eClass,
			FatherOfExistingFamilyToMale _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperation_name = performOperation.getName();
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_bindingAndBlackFFB(
			FatherOfExistingFamilyToMale _this) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_binding = pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_black = pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
		String ruleresult_rule_prime = "FatherOfExistingFamilyToMale";
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_2_corematch_bindingFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_FatherOfExistingFamilyToMale_12_2_corematch_blackBFBFB(Male p,
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_3_findcontext_black_nac_0B(Family f) {
	...
	public static final Iterable<Object[]> pattern_FatherOfExistingFamilyToMale_12_3_findcontext_blackBBBFB(Male p,
			...
			if (persons.equals(families2persons.getTarget())) {
				if (families.equals(families2persons.getSource())) {
					for (Family f : families.getFamily()) {
						if (pattern_FatherOfExistingFamilyToMale_12_3_findcontext_black_nac_0B(f) == null) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_3_findcontext_greenBBBBBFFFFF(Male p,
			FamiliesToPersonsCorr families2persons, Persons persons, Family f, Families families) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge families__f____family = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge persons__p____person = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_bindingFBBBBBBB(
			FatherOfExistingFamilyToMale _this, IsApplicableMatch isApplicableMatch, Male p,
			FamiliesToPersonsCorr families2persons, Persons persons, Family f, Families families) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_bindingAndBlackFBBBBBBB(
			FatherOfExistingFamilyToMale _this, IsApplicableMatch isApplicableMatch, Male p,
			FamiliesToPersonsCorr families2persons, Persons persons, Family f, Families families) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_binding = pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, p, families2persons, persons, f, families);
		if (result_pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_binding[0];

			Object[] result_pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_black = pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_blackB(
					csp);
			if (result_pattern_FatherOfExistingFamilyToMale_12_4_solveCSP_black != null) {
	...
	public static final boolean pattern_FatherOfExistingFamilyToMale_12_5_checkCSP_expressionFBB(
			FatherOfExistingFamilyToMale _this, CSP csp) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_12_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "FatherOfExistingFamilyToMale";
	...
	public static final IsApplicableRuleResult pattern_FatherOfExistingFamilyToMale_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_bindingFB(
			FatherOfExistingFamilyToMale _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_blackFBBF(EClass __eClass,
			FatherOfExistingFamilyToMale _this) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_bindingAndBlackFFBF(
			FatherOfExistingFamilyToMale _this) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_binding = pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_black = pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_1_preparereturnvalue_greenF() {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_black_nac_3BB(
			FamilyMember fm, Family f) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_black_nac_4BB(
			FamilyMember fm, Family f) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_black_nac_5BB(
			FamilyMember fm, Family f) {
	...
	public static final Iterable<Object[]> pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_blackFFFB(
			EMoflonEdge _edge_family_father) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		EObject tmpFm = _edge_family_father.getSrc();
		if (tmpFm instanceof FamilyMember) {
			FamilyMember fm = (FamilyMember) tmpFm;
			EObject tmpF = _edge_family_father.getTrg();
			if (tmpF instanceof Family) {
				Family f = (Family) tmpF;
				if (f.equals(fm.getFamily_father())) {
					if (pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_black_nac_0BB(fm, f) == null) {
						if (pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_black_nac_1BB(fm,
								f) == null) {
							if (pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_black_nac_2BB(fm,
									f) == null) {
								if (pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_black_nac_3BB(fm,
										f) == null) {
									if (pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_black_nac_4BB(fm,
											f) == null) {
										if (pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_black_nac_5BB(
												fm, f) == null) {
											for (Families families : org.moflon.core.utilities.eMoflonEMFUtil
													.getOppositeReferenceTyped(f, Families.class, "family")) {
												_result.add(new Object[] { f, fm, families, _edge_family_father });
											}
										}
									}
								}
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_2_testcorematchandDECs_greenFB(
			EClass __eClass) {
	...
	public static final boolean pattern_FatherOfExistingFamilyToMale_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Family f, FamilyMember fm, Families families) {
	...
	public static final boolean pattern_FatherOfExistingFamilyToMale_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			FatherOfExistingFamilyToMale _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_20_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_FatherOfExistingFamilyToMale_20_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_bindingFB(
			FatherOfExistingFamilyToMale _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_blackFBBF(EClass __eClass,
			FatherOfExistingFamilyToMale _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperation_name = __performOperation.getName();
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_bindingAndBlackFFBF(
			FatherOfExistingFamilyToMale _this) {
		Object[] result_pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_binding = pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_black = pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_21_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_FatherOfExistingFamilyToMale_21_2_testcorematchandDECs_blackFFB(
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_21_2_testcorematchandDECs_greenFB(
			EClass __eClass) {
		Match match = RuntimeFactory.eINSTANCE.createMatch();
		String __eClass_name = __eClass.getName();
		String match_ruleName_prime = __eClass_name;
	...
	public static final boolean pattern_FatherOfExistingFamilyToMale_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			FatherOfExistingFamilyToMale _this, Match match, Male p, Persons persons) {
	...
	public static final boolean pattern_FatherOfExistingFamilyToMale_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			FatherOfExistingFamilyToMale _this, Match match) {
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_21_5_Addmatchtoruleresult_blackBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		if (!__performOperation.equals(isApplicableCC)) {
			return new Object[] { match, __performOperation, __result, isApplicableCC };
		}
	...
	public static final Object[] pattern_FatherOfExistingFamilyToMale_21_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
		match.setIsApplicableCCOperation(isApplicableCC);
	...
	public static final EObjectContainer pattern_FatherOfExistingFamilyToMale_21_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}
	...
	public static final boolean pattern_FatherOfExistingFamilyToMale_28_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FatherOfExistingFamilyToMale_28_3_expressionF() {
		boolean _result = false;
		return _result;
	}
